...
function printHelp() {
    ...
    console.log('\nAvailable commands:')
    var commandList = Object.keys(commands_1.commands).map(function(c) {
        return {
            command: [c],
...
function viewLogs() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, nameNeeded()]
                case 1:
                    name = _a.sent()
                    return [
                        4 /*yield*/,
                        docker_1.docker.command('logs ' + name),
                    ]
                case 2:
                    data = _a.sent()
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [
                        4 /*yield*/,
                        docker_1.docker.command('inspect ' + name),
...
function listContainers() {
    docker_1.docker.command('ps').then(function(data) {
        var smaServers = data.containerList
            .filter(function(c) {
                return c.image.indexOf('magikcraft/scriptcraft') === 0
            })
            .map(function(c) {
...
function nameNeeded() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, server.getServerName(serverTarget)]
                case 1:
                    name = _a.sent()
                    if (name.isNothing) {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [
                        2 /*return*/,
                        new ghetto_monad_1.ErrorResult(
                            new Error('Server ' + name + ' is not running')
                        ),
                    ]
                case 4:
                    return [2 /*return*/]
...
function startNewInstance(name) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, server.getDockerTag()]
                case 1:
                    tag = _a.sent()
                ...
                case 3:
                    bind = _a.sent()
                    cache =
                        '--mount source=sma-server-cache,target=/server/cache'
                    _a.label = 4
                case 4:
                    _a.trys.push([4, 6, , 7])
                    dc =
                        ...
                        ' ' +
                        cache +
                        ' --restart always magikcraft/scriptcraft:' +
                        tag
    ...
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 1:
                    worlds = _a.sent()
                        ? mount(paths_1.worldsPath(), 'worlds')
                        : ''
                    plugins = mount(
                        paths_1.pluginsPath(),
                        'scriptcraft-plugins'
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        docker_1.docker.command('stop ' + name),
                    ]
                case 1:
                    _a.sent()
                    return [2 /*return*/]
