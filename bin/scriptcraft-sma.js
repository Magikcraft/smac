...
var columnify_1 = require('columnify')
    ...
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 2:
                    status = _a.sent()
                    if (!status.isError) return [3 /*break*/, 3]
...
function nameNeeded() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, server_1.getServerName(serverTarget)]
                case 1:
                    name = _a.sent()
                    if (name.isNothing) {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent()
                    console.log(
                        'Server ' + name + ' started on localhost:' + port
                    )
                    return [3 /*break*/, 7]
                case 6:
                    e_2 = _a.sent()
